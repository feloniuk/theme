...
export default class SidebarMenuPlugin extends Plugin {
    ...
    _addClickFeedback(element) {
        ...
        // Применяем анимацию нажатия с кубической кривой Безье как у Apple
        element.style.transition = 'transform 0.15s cubic-bezier(0.2, 0, 0.13, 1.5)';
        element.style.transform = 'scale(0.96)';

        // Используем requestAnimationFrame для более точного тайминга
        requestAnimationFrame(() => {
            setTimeout(() => {
